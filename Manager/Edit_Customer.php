        ...
        <form method="post" enctype="multipart/form-data" class="p-4  border rounded-3 bg-light">
                ...
                <?php 
                    if(isset($_POST['Submit'])){
                        ...
                        $select = "SELECT * FROM Customer_tbl WHERE Customer_ID='$customer_id'";
                        $query=mysqli_query($conn,$select);
                        $row_num = mysqli_num_rows($query);
                        while ($row=mysqli_fetch_assoc($query)){
            ...
            <h3>EDIT CUSTOMER</h3>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo $Customer_name; ?>" readonly name="acc_type" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>GENDER:</strong></span>
                    <input type="text" class="form-control" value="<?php echo $Gender; ?>" readonly name="balance" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>DATE OF BIRTH:</strong></span>
                    <input type="text" class="form-control" value="<?php echo $DOB; ?>" readonly name="balance" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>ADDRESS:</strong></span>
                    <input type="text" class="form-control" value="<?php echo $Address; ?>"  name="address" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>CITY:</strong></span>
                    <input type="text" class="form-control" value="<?php echo $City; ?>"  name="city" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>STATE:</strong></span>
                    <input type="text" class="form-control" value="<?php echo $State; ?>"  name="state" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>PIN:</strong></span>
                    <input type="number" class="form-control" value="<?php echo $PIN; ?>"  name="pin" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>MOBILE NUMBER:</strong></span>
                    <input type="text" class="form-control" value="<?php echo $phone; ?>"  name="phone" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>E-MAIL:</strong></span>
                    <input type="text" class="form-control" value="<?php echo $Email; ?>"  name="email" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                
                <div class="input-group mb-3">
                    <button type="submit" class="w-100 btn btn-lg btn-primary" name="Sub">Submit</button>
                </div>
                <div class="input-group mb-3">
                    <button type="reset" class="w-100 btn btn-lg btn-outline-primary">Reset</button>
                </div>
            ...
            <?php  }
                if(isset($_POST['Sub'])){
                    $customer = $_SESSION['come'];
                $add = trim($_POST['address']);
                $cit = trim($_POST['city']);
                $stat = trim($_POST['state']);
                $PIN = trim($_POST['pin']);
                $phone = trim($_POST['phone']);
                $email = trim($_POST['email']);
                $update = "UPDATE Customer_tbl SET Address='$add' City='$cit' State='$stat' PIN='$PIN' phone='$phone' Email='$email' WHERE Customer_ID='$customer'";
