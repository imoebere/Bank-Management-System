    ...
    <div class="row  g-lg-5 py-5">
      ...
      <div class="col-md-10 col-lg-6">
            <form class="p-4  border rounded-3 bg-light">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>Username:</strong></span>
                    <input type="text" class="form-control" readonly value="<?php echo substr($user,0,12);?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default"><strong>Password:</strong></span>
                    <input type="text" class="form-control" readonly value="<?php echo md5($password);?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
            </form>
